...
async function seedGifts() {
  ...
  const gifts = [
    [1,  'Geladeira Frost Free 460L',      'casa',       '🧊', 'Duplex inverter 460L, inox escovado, eficiência A+++.',        4000, 100, 40, '/img/presentes/geladeira.png'],
    [2,  'Máquina de Lavar 12kg',          'casa',       '🌀', 'Direct Drive, 12 programas, baixo consumo de água.',          2800,  70, 40, '/img/presentes/maquinalavar.jpg'],
    [3,  'Air Fryer Digital 12L',          'cozinha',    '🥘', '12 funções, display touchscreen, dupla cesta, 12L.',          500,   10, 50, '/img/presentes/airfryer.png'],
    [4,  'Jogo de Panelas Premium',        'cozinha',    '🍳', 'Antiaderente cerâmico, livre de PFOA, alças ergonômicas.',    480,   10, 48, '/img/presentes/panelas.png'],
    [5,  'Cafeteira Expresso',             'cozinha',    '☕', '15 bar de pressão, vaporizador de leite, corpo em inox.',     620,   10, 62, '/img/presentes/cafeteira.jpg'],
    [6,  'Liquidificador Alta Potência',   'cozinha',    '🥤', '1500W, copo de vidro 2L, 6 velocidades + pulsar.',            290,   10, 29, '/img/presentes/liquidificador.png'],
    [7,  'Home Theater 5.1 Surround',      'casa',       '🔊', 'Sistema imersivo com subwoofer ativo e Bluetooth.',           1800,  50, 36, '/img/presentes/hometheater.jpg'],
    [8,  'Jogo de Cama Queen 400 Fios',    'cama-banho', '🛏️','100% algodão egípcio, 4 peças, cor lavanda.',                 520,   10, 52, '/img/presentes/cama.jpg'],
    [9,  'Jogo de Toalhas 8 Peças',        'cama-banho', '🛁', 'Algodão penteado 600g/m², super absorvente, cor areia.',      340,   10, 34, '/img/presentes/toalhas.png'],
    [10, 'Fundo para a Lua de Mel',        'experiencia','✈️', 'Contribua para a viagem dos sonhos de Luciana e Wellington!', 8000, 100, 80, '/img/presentes/luademel.jpg'],
    [11, 'Jantar Romântico a Dois',        'experiencia','🍽️','Voucher para jantar a dois em restaurante italiano premiado.',  400,  10, 40, '/img/presentes/jantar.jpg'],
    [12, 'Spa Day para o Casal',           'experiencia','💆', 'Massagem, hidratação e piscina termal para dois.',             580,  10, 58, '/img/presentes/spa.jpg'],
    [13, 'Tapete Sala 2×3m',              'casa',       '🏠', 'Fibra natural trançada, estilo escandinavo, tons neutros.',    480,  10, 48, '/img/presentes/tapete.png'],
  ];
